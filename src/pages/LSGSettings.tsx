...
export default function LSGSettings() {
  ...
  const [notificationSettings, setNotificationSettings] = useState<NotificationSetting[]>([
    ...
    },
    {
      id: "3",
      title: "Scan Alerts",
      description: "Receive alerts about duplicate or invalid QR scans",
      enabled: true,
      category: "Scanner",
    },
    {
  ...
  const [userData, setUserData] = useState({
    email: "lsg@university.edu",
    phone: "+63 900 123 4567",
    organization: "Leadership Student Government",
